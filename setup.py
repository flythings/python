...
setup(
  name = 'flythingsClient',
  packages = ['flythingsClient'], # this must be the same as the name above
  version = '0.1',
  ...
  download_url = 'https://github.com/flythings/python/0.1.tar.gz', # I'll explain this in a second
