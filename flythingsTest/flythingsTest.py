...
def sendObservations_test():
	observations = []
	observations.append(flythings.getObservation(20, "test1", None, None, None, "ob1", "multiple"))
	observations.append(flythings.getObservation(30, "test2", None, None, None, "ob1", "multiple"))
	observations.append(flythings.getObservation(40, "test3", None, None, None, "ob1", "multiple"))
	observations.append(flythings.getObservation(50, "test4", "uoms", round(time.time() * 1000), None, "ob1", "multiple"))
